    	...
    	<div class="articleNode">
            <div class="articleTitle">
                ...
                <div class="titleRight">
                    <h3><a href="/test/index.php?action=post/view&uid=<?php echo $post['uid'];?>"><?php echo $post['title'];?></a></h3>
                    <div class="articleTags">
                    	<?php foreach($post['tags'] as $tag){?><a href="/test/index.php?action=post/tag&uid=<?php echo $tag['uid'];?>"><?php echo $tag['tag'];?></a><span>/</span><?php }?><a class="created"><?php echo date('Y.m.d', $post['created']);?></a>
                    </div>
                </div>
            ...
            <div class="articleInfo">
                ...
                <div class="readmore">
                	<a href="/test/index.php?action=post/view&uid=<?php echo $post['uid'];?>">阅读全文</a>
                </div>
                <div style="clear:both"></div>
            </div>
    	</div>
